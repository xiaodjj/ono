...
import moe.ono.loader.modern.ModernHookEntry;
import moe.ono.R;
...
public class Parasitics {
    ...
    public static void injectModuleResources(Resources res) {
        ...
        try {
            res.getString(R.string.resources_inject_state);
            return;
        } catch (Resources.NotFoundException ignored) {
        }
        String sModulePath = StartupInfo.getModulePath();
        if (sModulePath == null) {
            throw new RuntimeException("get module path failed, loader=" + QLauncher.class.getClassLoader());
        }
        ...
        Logger.i("Inject Module Resources....");
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logger.i("WTF: Unable to get IActivityManagerSingleton");
                    Logger.e(err1);
                    Logger.e(err2);
                    return;
                }
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            if ("startActivity".equals(method.getName())) {
                ...
                if (index != -1) {
                    ...
                    if (component != null && hostApp.getPackageName().equals(component.getPackageName()) && ActProxyMgr.isModuleProxyActivity(component.getClassName())) {
                        boolean isTranslucent = false;
                        boolean isToolProcess = "moe.ono.activity.ShadowShareFileAgentActivity".equals(component.getClassName());
                        try {
        ...
        public void callActivityOnCreate(Activity activity, Bundle icicle) {
            if (icicle != null) {
                ...
                if (ActProxyMgr.isModuleBundleClassLoaderRequired(className)) {
                    icicle.setClassLoader(ModernHookEntry.class.getClassLoader());
                }
            }
