...
public class ICreator extends BottomPopupView{
    ...
    private View createPicImage(String imgPath, String title, OnClickListener clickListener, LocalDataHelper.LocalPath path) {
        ...
        View blueTip = new View(getContext());
        blueTip.setBackgroundColor(Color.parseColor("#81D4FA"));
        panel_param = new LinearLayout.LayoutParams(LayoutHelper.dip2px(getContext(), 30), 50);
        panel_param.leftMargin = LayoutHelper.dip2px(getContext(), 5);
        panel_param.rightMargin = LayoutHelper.dip2px(getContext(), 5);
        blueTip.setLayoutParams(panel_param);
        blueTip.setId(887533);
        blueTip.setVisibility(GONE);
        panel.addView(blueTip);
    ...
    protected void onCreate() {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            open_last_select = ONOConf.getBoolean("global", "sticker_panel_set_open_last_select", false);
            if (open_last_select) savedSelectID = Long.parseLong(ONOConf.getString("global", "sticker_panel_set_last_select", String.valueOf(savedSelectID)));
            if (savedSelectID != 0){
    ...
    protected void beforeDismiss() {
        if (currentTab != null){
            ...
            if (open_last_select) ONOConf.setString("global", "sticker_panel_set_last_select",String.valueOf(savedSelectID));
